...
from scriptedBot import TypeMatchupPlayer
...
async def main():
    ...
    opponent = TypeMatchupPlayer(battle_format="gen8randombattle")
    ...
    print("Results against team matchup:")
    ...
    print('cross evaluation start')
    n_challenges = 50
    players = [
        eval_env.agent,
        RandomPlayer(battle_format="gen8randombattle"),
        MaxBasePowerPlayer(battle_format="gen8randombattle"),
        TypeMatchupPlayer(battle_format="gen8randombattle")
    ]
